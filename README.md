...
> **ต้องรันก่อนใช้แท็บ "งบ"**: `20260902000100_add_category_budgets.sql`
> เพิ่มคอลัมน์ `user_settings.category_budgets_json` สำหรับงบรายหมวด
> ถ้ายังไม่รัน หน้าดังกล่าวจะขึ้นข้อความให้รัน migration แทนที่จะพังทั้งหน้า
